import {
  ...
  QueryClientProvider,
  img
} from "./chunk-5UAOY4AE.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-FAKOFX54.js";
import {
  useNpsSurveySettings
} from "./chunk-NSTPC4R2.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-OH6EVNLL.js";
import {
  useGetAIUsageQuery
} from "./chunk-YS24QIDF.js";
import {
  require_pick
} from "./chunk-4WQTZV7Z.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-NYRWCO4C.js";
import {
  useEnterprise
} from "./chunk-AEXGQCCS.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-67OTEY2N.js";
import {
  Login
} from "./chunk-GE4PUTNT.js";
import {
  MemoizedInputRenderer
} from "./chunk-PG6VKWWW.js";
import {
  Form
} from "./chunk-5CG72DFE.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-IA233WH5.js";
import {
  ConfigurationProvider
} from "./chunk-F3ECOTSW.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-QEAGKT3G.js";
import {
  require_baseRest
} from "./chunk-XUQMSJME.js";
import {
  HistoryProvider
} from "./chunk-WL6XCMKQ.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-AELHBOVZ.js";
import {
  Layouts
} from "./chunk-QQAPZIII.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-J5FKLKKH.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-QPP5DPEB.js";
import {
  getByteSize
...
} from "./chunk-T3LG7B5T.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-FUJ4NPKZ.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-DUH7KVW5.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-IAKWBZ42.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-NJAFC5IU.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-LMXEGQ4J.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-EQ5RS6D5.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ER5KCYWK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-UGNMB4S7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-L432SI4U.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-R42H57AY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-NE7O7RRT.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-XHHGZ26Q.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-MTLJJXRE.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-663RWNU4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-JGKGIXOT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UTXSKBRU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-MJ3XMHMZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-CHDBUPOL.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-PMWLHQJC.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-XBKHBTPJ.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-WCMJW3FN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-6ZN3CAQB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-LW2WHUNS.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-MV2ZUTTJ.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-TF4GSRY2.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-5KRTMHER.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-7R22TGJN.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-E4DXYVGT.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-THRIM35U.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-BOEOBBBJ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-U5MC2ZXE.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-WPITCGHG.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-WPITCGHG.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-JLH5VX5D.js");
...
//# sourceMappingURL=chunk-T3ZKN4C5.js.map

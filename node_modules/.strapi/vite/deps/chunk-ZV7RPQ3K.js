import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-NJLZ5FJD.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-FF7NVPHG.js";
import {
  LimitsModal
} from "./chunk-3TJ6RPKB.js";
import {
...
} from "./chunk-E6DIRGAN.js";
import {
  useTypedSelector
} from "./chunk-IFVPSMYZ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-24NQDCUN.js";
import {
  useConfig,
  useTracking
} from "./chunk-DXEWOLO4.js";
import {
  AssetSource,
  AssetType,
...
import {
  renderAdmin
} from "./chunk-T3ZKN4C5.js";
import {
  useAIAvailability
} from "./chunk-OH6EVNLL.js";
import {
  useLicenseLimits
} from "./chunk-XMQOVTGA.js";
import {
  Table,
  useTable
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-FFO5ZTOT.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-APOFSSWN.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-KULBRNMT.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-XWDE3OU5.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OVGX6HTW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-LWFAR5FA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-JX4DJJR6.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-SIHLQ4ST.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-5IZNCLWT.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-4LGEA76B.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-DV3YIFFN.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-HHJNT2AY.js");
          return {
...
//# sourceMappingURL=chunk-ZV7RPQ3K.js.map
